...
try{
    ...
    $mail->Subject = 'Registered in ' . CONFIG['APP_NAME'];
    ...
    $mail->Body = sprintf($body, CONFIG['URL'], $data['activationCode'], $data['email'], CONFIG['APP_NAME'], CONFIG['URL'] . CONFIG['APP_IMAGE'], CONFIG['URL'], CONFIG['URL']);
