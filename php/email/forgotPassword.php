...
try{
    ...
    $mail->Subject = "Password Recovery (" . CONFIG['APP_NAME'] . ')';
    ...
    $mail->Body = sprintf($body, CONFIG['URL'], $data['resetPasswordCode'], $user['email'], CONFIG['APP_NAME'], CONFIG['URL'] . CONFIG['APP_IMAGE'], CONFIG['URL'], CONFIG['URL']);
